<?php // recovery-change_password
    ...
    $new_password    = isset($jsonObject->new_password) ? clean_data(trim_double($jsonObject->new_password)) : "";
    ...
    if ( ! isset($result['fetched'][0]['secret_key_bearer']) || strlen($new_password) < 8 )
    {
    $error_code = '403-01';
    ...
    ## Procedemos a cambiar la contraseña del usuario
